...
home :: https://github.com/zenspider/rrobots
rdoc :: http://docs.seattlerb.org/rrobots
...
All you need to implement is the tick method which should accept a
hash of events that occurred during the last tick.

See Robot for full documentation of the methods and accessors
available to your AI during the game.

RRobots is implemented in pure ruby using a Gosu ui and should run on
all platforms that have ruby and Gosu.
...
Copyright (c) Ryan Davis, seattle.rb; Jason Jones; Simon Kröger; others?
